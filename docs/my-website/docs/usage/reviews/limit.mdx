...
Like you saw and used in the `limit()` method of the <a href="../products/limit.mdx">products</a>, There is a `limit()` method that belongs to the reviews, and you can call it simply, in this example, this will limit the reviews obtained to 10 as maximum :
